...
<img src="/guides/domains/media/cloudflare/cloudflare_step_1.png" alt="Cloudflare dashboard with Add a Site highlighted" />

3. Enter your **full subdomain**, for example `yourname.indevs.in`.
4. Click **Continue**.

<img src="/guides/domains/media/cloudflare/cloudflare_step_2.png" alt="Cloudflare add site form with subdomain field" />
...
<img src="/guides/domains/media/cloudflare/cloudflare_step_3.png" alt="Cloudflare plan selection with Free highlighted" />
...
<img src="/guides/domains/media/cloudflare/cloudflare_step_4.png" alt="Cloudflare nameservers assigned to the new site" />
...
<img src="/guides/domains/media/cloudflare/check_button.png" alt="Cloudflare Check nameservers now button" />
...
<img src="/guides/domains/media/cloudflare/domain_live.png" alt="Cloudflare success message showing the domain is active" />
...
<img src="/guides/domains/media/cloudflare/cloudflare_step_5.png" alt="Cloudflare DNS Records page" />

2. Click **Add record**.
3. Configure the record based on your needs:

<img src="/guides/domains/media/cloudflare/cloudflare_step_6.png" alt="Cloudflare Add record form" />
