...
<img src="/products/domains/media/dashboard/img_1.png" alt="Stackryze Domains dashboard showing domain detail page" />
...
<Steps>
  <Step title="Set up the new provider">
    Create the zone at your new provider first. See the [DNS providers](/products/domains/dns-providers) list for step-by-step guides.
  </Step>
...
<img src="/products/domains/media/dashboard/domain-list.png" alt="Domain list with Renew button highlighted" />
...
<img src="/products/domains/media/dashboard/cannot-renew.png" alt="Cannot renew message shown when outside the renewal window" />
...
- Pick a reliable DNS provider. [Cloudflare](/products/domains/dns-providers/cloudflare) is a good default.
...
- [Troubleshooting](/products/domains/troubleshooting)
- [Getting started](/products/domains/getting-started)
- [DNS providers](/products/domains/dns-providers)
