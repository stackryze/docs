...
This guide walks you through creating your account and registering your first `indevs.in` subdomain on Stackryze Domains.
...
<img src="/products/domains/media/stackryze/img_1.png" alt="Stackryze Domains landing page with Get Started button" />
...
<img src="/products/domains/media/stackryze/img_3.png" alt="Stackryze Domains dashboard with Register Domain in the sidebar" />

## Step 4 — Complete the registration form

<img src="/products/domains/media/stackryze/img_4.png" alt="Stackryze Domains registration form" />
...
- Set up DNS records with your preferred provider — start with the [Cloudflare guide](/products/domains/dns-providers/cloudflare).
- Learn how to [manage your domain](/products/domains/managing-domains).
...
- [Troubleshooting](/products/domains/troubleshooting) — common errors and fixes.
