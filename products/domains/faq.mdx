...
See [Managing domains → Renewing domains](/products/domains/managing-domains#renewing-domains).
...
Five by default. Need more? Email [support@stackryze.com](mailto:support@stackryze.com).

See [Managing domains → Domain limits and quotas](/products/domains/managing-domains#domain-limits-and-quotas).
...
See the [Getting started guide](/products/domains/getting-started).
...
See [Troubleshooting → Domain registration issues](/products/domains/troubleshooting#domain-registration-issues).
...
See [DNS providers](/products/domains/dns-providers).
...
Start with [Cloudflare setup](/products/domains/dns-providers/cloudflare).

### How long does DNS propagation take?

Typically 5–10 minutes, but up to 48 hours globally.

See [Troubleshooting → DNS and nameserver issues](/products/domains/troubleshooting#dns-and-nameserver-issues).
...
See [Managing domains → What if you don't renew?](/products/domains/managing-domains#what-if-you-dont-renew).

### How do I delete a domain?

Open the domain page → **Danger Zone** → **Delete Domain**. DNS is removed immediately.

See [Managing domains → Deleting domains](/products/domains/managing-domains#deleting-domains).
...
See [Troubleshooting → Login issues](/products/domains/troubleshooting#login-issues).
...
See [Troubleshooting → Domain management issues](/products/domains/troubleshooting#domain-management-issues).
...
<Columns cols={2}>
  ...
  <Card title="Troubleshooting" icon="wrench" href="/products/domains/troubleshooting">
