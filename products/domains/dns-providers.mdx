...
<Card title="Cloudflare setup guide" icon="cloud" href="/products/domains/dns-providers/cloudflare">
...
<Card title="Route 53 setup guide" icon="aws" href="/products/domains/dns-providers/route53">
  Step-by-step walkthrough with screenshots.
</Card>
...
<Card title="Google Cloud DNS setup guide" icon="google" href="/products/domains/dns-providers/google-cloud-dns">
  Quick setup.
</Card>
...
<Card title="Azure DNS setup guide" icon="microsoft" href="/products/domains/dns-providers/azure-dns">
  Quick setup.
</Card>
...
<Card title="DigitalOcean setup guide" icon="water" href="/products/domains/dns-providers/digitalocean">
  Step-by-step walkthrough with screenshots.
</Card>
...
<Card title="Hetzner setup guide" icon="server" href="/products/domains/dns-providers/hetzner">
  Quick setup.
</Card>
...
<Card title="ClouDNS setup guide" icon="cloud" href="/products/domains/dns-providers/cloudns">
  Quick setup.
</Card>
...
<Card title="HE.net setup guide" icon="globe" href="/products/domains/dns-providers/hurricane-electric">
  Quick setup.
</Card>
...
<Card title="Namecheap FreeDNS setup" icon="tag" href="/products/domains/dns-providers/namecheap">
  Quick setup.
</Card>
...
<Card title="Vercel DNS setup" icon="triangle" href="/products/domains/dns-providers/vercel-dns">
  Quick setup.
</Card>
...
<Card title="deSEC setup" icon="shield" href="/products/domains/dns-providers/desec">
  Quick setup.
</Card>
...
<Card title="PowerDNS self-hosted setup" icon="server" href="/products/domains/dns-providers/powerdns">
...
<Card title="Custom DNS server setup" icon="wrench" href="/products/domains/dns-providers/custom">
...
Start with [Cloudflare](/products/domains/dns-providers/cloudflare):
...
[Route 53](/products/domains/dns-providers/route53) integrates cleanly with other AWS services.

### For budget projects

[Hurricane Electric](/products/domains/dns-providers/hurricane-electric) and [ClouDNS](/products/domains/dns-providers/cloudns) are fully free.

### For enterprise

[Route 53](/products/domains/dns-providers/route53), [Google Cloud DNS](/products/domains/dns-providers/google-cloud-dns), and [Azure DNS](/products/domains/dns-providers/azure-dns) provide enterprise-grade reliability with SLA guarantees.
